...
public final class BiomeMegaTaiga extends BiomeBase {
    ...
    public BiomeMegaTaiga() {
        super((new BiomeBase.a()).a(WorldGenSurface.W, WorldGenSurface.D).a(BiomeBase.Precipitation.RAIN).a(BiomeBase.Geography.TAIGA).a(0.2F).b(0.2F).c(0.3F).d(0.8F).a((new BiomeFog.a()).b(4159204).c(329011).a(12638463).a(CaveSoundSettings.b).a()).a((String) null));
