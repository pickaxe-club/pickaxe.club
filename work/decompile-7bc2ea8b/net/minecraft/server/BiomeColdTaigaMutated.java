...
public final class BiomeColdTaigaMutated extends BiomeBase {
    ...
    public BiomeColdTaigaMutated() {
        super((new BiomeBase.a()).a(WorldGenSurface.S, WorldGenSurface.D).a(BiomeBase.Precipitation.SNOW).a(BiomeBase.Geography.TAIGA).a(0.3F).b(0.4F).c(-0.5F).d(0.4F).a((new BiomeFog.a()).b(4020182).c(329011).a(12638463).a(CaveSoundSettings.b).a()).a("snowy_taiga"));
