...
public class BlockSweetBerryBush extends BlockPlant implements IBlockFragilePlantElement {
    ...
    public BlockSweetBerryBush(Block.Info block_info) {
        super(block_info);
        this.p((IBlockData) ((IBlockData) this.blockStateList.getBlockData()).set(BlockSweetBerryBush.a, 0));
    }
    ...
    public void a(IBlockData iblockdata, World world, BlockPosition blockposition, Entity entity) {
        if (entity instanceof EntityLiving && entity.getEntityType() != EntityTypes.FOX && entity.getEntityType() != EntityTypes.BEE) {
            ...
            if (!world.isClientSide && (Integer) iblockdata.get(BlockSweetBerryBush.a) > 0 && (entity.E != entity.locX() || entity.G != entity.locZ())) {
                double d0 = Math.abs(entity.locX() - entity.E);
