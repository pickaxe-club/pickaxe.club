...
public final class BiomeFrozenRiver extends BiomeBase {
    ...
    public BiomeFrozenRiver() {
        super((new BiomeBase.a()).a(WorldGenSurface.S, WorldGenSurface.D).a(BiomeBase.Precipitation.SNOW).a(BiomeBase.Geography.RIVER).a(-0.5F).b(0.0F).c(0.0F).d(0.5F).a((new BiomeFog.a()).b(3750089).c(329011).a(12638463).a(CaveSoundSettings.b).a()).a((String) null));
