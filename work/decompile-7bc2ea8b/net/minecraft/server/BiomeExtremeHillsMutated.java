...
public final class BiomeExtremeHillsMutated extends BiomeBase {
    ...
    protected BiomeExtremeHillsMutated() {
        super((new BiomeBase.a()).a(WorldGenSurface.V, WorldGenSurface.D).a(BiomeBase.Precipitation.RAIN).a(BiomeBase.Geography.EXTREME_HILLS).a(1.0F).b(0.5F).c(0.2F).d(0.3F).a((new BiomeFog.a()).b(4159204).c(329011).a(12638463).a(CaveSoundSettings.b).a()).a("mountains"));
