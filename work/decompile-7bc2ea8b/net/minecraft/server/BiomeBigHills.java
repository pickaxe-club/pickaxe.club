...
public final class BiomeBigHills extends BiomeBase {
    ...
    protected BiomeBigHills() {
        super((new BiomeBase.a()).a(WorldGenSurface.T, WorldGenSurface.D).a(BiomeBase.Precipitation.RAIN).a(BiomeBase.Geography.EXTREME_HILLS).a(1.0F).b(0.5F).c(0.2F).d(0.3F).a((new BiomeFog.a()).b(4159204).c(329011).a(12638463).a(CaveSoundSettings.b).a()).a((String) null));
