...
public final class BiomeSavannaPlateauMutated extends BiomeBase {
    ...
    public BiomeSavannaPlateauMutated() {
        super((new BiomeBase.a()).a(WorldGenSurface.U, WorldGenSurface.D).a(BiomeBase.Precipitation.NONE).a(BiomeBase.Geography.SAVANNA).a(1.05F).b(1.2125001F).c(1.0F).d(0.0F).a((new BiomeFog.a()).b(4159204).c(329011).a(12638463).a(CaveSoundSettings.b).a()).a("savanna_plateau"));
